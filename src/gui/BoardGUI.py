...
class BoardGUI:
    ...
    def draw_board(self,board,screen,radius,height,myfont):
        ...
        for c in range(self.board_Height):
            for r in range(self.board_Width):
                pygame.draw.rect(screen, YELLOW, (c * self.square_size, r * self.square_size + self.square_size, self.square_size, self.square_size))
        ...
        for c in range(self.board_Height):
            for r in range(self.board_Width):
                if board[r][c] == 1:
                    ...
                    screen.blit(label, label.get_rect(center=(int(c * self.square_size + self.square_size / 2), height - int(r * self.square_size + self.square_size / 2))))
        ...
        while not self.game_end:
            ...
            if self.mode=="Human_Human":
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.MOUSEMOTION:
                        ...
                        if self.turn == 1:
                            ...
                            pygame.draw.circle(screen, BLUE, (posx, int(self.square_size / 2)), radius)
                ...
                if self.turn == 1:
                    ...
                    col = AIAgent.getNextMove_MinMAX(self.board,self.board_Width,self.board_Height)
